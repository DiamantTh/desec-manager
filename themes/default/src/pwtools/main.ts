 ...
 *
 * Wortliste: identisch mit PHP-Klasse PasswordGenerator (gleiche Entropy-Basis).
 */
...
// ---------------------------------------------------------------------------
// Wortliste (identisch mit PHP PasswordGenerator::WORDLIST)
// ---------------------------------------------------------------------------
...
function generatePassphrase(wordCount = 5, separator = '-'): string {
    ...
    for (let i = 0; i < wordCount; i++) {
        words.push(WORDLIST[randomInt(WORDLIST.length - 1)]);
    }
